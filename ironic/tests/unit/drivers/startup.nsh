...
#
set -v grubx64.efi http://192.168.122.184:9000//httpboot/grubnetx64.efi.signed
set -v kernel http://192.168.122.184:9000//httpboot/f9eaed3c-8ae0-4956-9592-c8a4fd327d18/deploy_kernel
set -v ramdisk http://192.168.122.184:9000//httpboot/f9eaed3c-8ae0-4956-9592-c8a4fd327d18/deploy_ramdisk
set -v grub http://192.168.122.184:9000//httpboot/f9eaed3c-8ae0-4956-9592-c8a4fd327d18/grub.cfg
...
#
echo "Downloading %grubnetx64.efi% (File 1 of 3...)"
webclient -g %grubx64.efi% -o grubx64.efi.signed
if %lasterror% ne 0x0 then
  goto EXITSCRIPT
endif

echo "Downloading %kernel% (File 2 of 3...)"
webclient -g %kernel% -o kernel
if %lasterror% ne 0x0 then
  goto EXITSCRIPT
endif

echo "Downloading %ramdisk% (File 3 of 3...)"
