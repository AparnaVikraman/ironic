...
#
#set -v Url http://10.10.1.30

#
# Files to be downloaded
#
set -v DownloadFile1 {{uefi_bootfile}}
set -v DownloadFile2 {{kernel}}
set -v DownloadFile3 {{ramdisk}}
set -v grub {{grub}}
...
webclient -g %DownloadFile1% -o grubx64.efi.signed
if %lasterror% ne 0x0 then
  goto EXITSCRIPT
endif

echo "Downloading %DownloadFile2% (File 2 of 3...)"
webclient -g %DownloadFile2% -o kernel
if %lasterror% ne 0x0 then
  goto EXITSCRIPT
endif

echo "Downloading %DownloadFile3% (File 3 of 3...)"
webclient -g %DownloadFile3% -o ramdisk
if %lasterror% ne 0x0 then
  goto EXITSCRIPT
endif
...
cd ..
cd ..
echo "Creating a new directory EFI"
mkdir EFI
cd EFI
echo "Creating a new directory EFI/ubuntu"
mkdir ubuntu
cd ubuntu
